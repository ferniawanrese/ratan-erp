		...
		<div class="row-fluid">
					<div class="content-widgets gray">
						<div class="widget-head blue clearfix">
						  <h3 class="pull-left" onclick="display_data()" style="cursor:pointer;">Asset Group Data</h3>							
						</div>
															
						<div class="well col-sm-12 col-md-12">
						<form id = "form_filter"  method="post">
							<div class = "col-md-3 btn-create">
								<input type ="text" name ="search" id="search" class="form-control" placeholder="Group Name">
							</div> 
...
function display_data(){ 
	...
	$.ajax({
				type: "POST",
				url: "<?php echo base_url('asset/asset_group_data/');?>",
...
function assetgroup_add(a){
	...
	$.ajax({
				...
				url: "<?php echo base_url('asset/asset_group_add/');?>" +"/"+ a,
				success: function(data){     
