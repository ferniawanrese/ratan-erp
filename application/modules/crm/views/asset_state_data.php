				...
				<tr>				
					...
					<td class="center">
							<div class="btn-toolbar row-action">
									...
									<button class="btn btn-info" title="Edit" onclick=assetgroup_add("<?php echo $keys['asset_stateID'];?>")><i class="icon-edit"></i></button>
									<button class="delete btn btn-danger" title="Delete" onclick=delete_post("<?php echo $keys['asset_stateID'];?>")><i class="icon-trash "></i></button>								
							</div>
					 </td>
				</tr>
