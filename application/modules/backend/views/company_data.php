		...
		<?php if($companies):?>		
			<?php foreach($companies as $comp):?>
				<tr>				
					...
					<td><?php echo $comp['found_year'];?></td>
					<td class="center">
							<div class="btn-toolbar row-action">
								
									<button class="btn btn-info" title="Edit" onclick=edit_company("<?php echo $comp['company_ID'];?>")><i class="icon-edit"></i></button>
									<button class="delete btn btn-danger" title="Delete" onclick=delete_post("<?php echo $comp['company_ID'];?>")><i class="icon-trash "></i></button>
...
<script type='text/javascript'>
			var options = {
				...
				onPageClicked: function changepage(e,originalEvent,type,page){
					...
					$.ajax({
					type: "POST",
					url: "<?php echo base_url('backend/company_data/');?>" + "/" + page,
