		...
		<div class="row-fluid">
					<div class="content-widgets gray">
						<div class="widget-head blue clearfix">
						  <h3 class="pull-left" onclick="display_data()" style="cursor:pointer;">Project Data </h3>							
						</div>
															
						<div class="well col-sm-12 col-md-12">
						<form id = "form_filter"  method="post">
							<div class = "col-md-3 btn-create">
								<input type ="text" name ="search" id="search" class="form-control" placeholder="Poject Name">
							</div>
...
function display_data(){ 
	...
	$.ajax({
				type: "POST",
				url: "<?php echo base_url('hrd/project_data/');?>",
...
function job_position_update(a){
	...
	$.ajax({
				...
				url: "<?php echo base_url('hrd/project_add/');?>" +"/"+ a,
				success: function(data){     
...
function delete_post(a){
	...
	bootbox.confirm("Are you sure you want to delete this?", function (result) {
					...
					if(result == true){						
						$.ajax({
									url: "<?php echo base_url('hrd/project_deleted/')?>/" + a,									
									success: function(data)
									{											
											display_data();
									}
