<!-- Navbar
	...
	<div class="navbar navbar-inverse top-nav">
		<div class="navbar-inner">
			<div class="container">
				<span class="home-link"><a href="index.html" class="icon-home"></a></span><a class="brand" href="./index.html"><img src="upload/img/logo-falgun.png" width="103" height="50" alt="Falgun"></a>
				...
				<div class="btn-toolbar pull-right notification-nav">
					...
					<div class="btn-group">
						<div class="dropdown">
							<a class="btn btn-notification" href="<?php echo base_url();?>"><i class="icon-lock"></i></a>
						</div>
					</div>
				</div>
			</div>
