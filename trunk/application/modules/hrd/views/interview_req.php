						...
						<div class="row-fluid">
									<div class="content-widgets gray">
										<div class="widget-head blue clearfix">
										  <h3 class="pull-left" onclick="display_data()" style="cursor:pointer;"> Interview Request</h3> 
										</div> 		
										<div class="well col-sm-12 col-md-12">
										
											<div  id = "btn-create" class="form-group">
												<button class="btn btn-inverse btn-large icon-plus" type="button" onclick = "add_interview()"> Create</button>
...
function add_interview(){
	...
	$.ajax({
				...
				url: "<?php echo base_url('hrd/add_interview_req/');?>",
				success: function(data){     
