				...
				<tr>				
					...
					<td class="center">
							<div class="btn-toolbar row-action">
									<button class="btn btn-info" title="Edit" onclick=payslip_add("<?php echo $keys['employee_ID'];?>")><i class="icon-edit"></i></button>
...
<script type='text/javascript'>
			var options = {
				...
				onPageClicked: function changepage(e,originalEvent,type,page){
					...
					$.ajax({
					type: "POST",
					url: "<?php echo base_url('hrd/payslip_data/');?>" + "/" + page,
