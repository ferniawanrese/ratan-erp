				...
				<tr>				
					...
					<td class="center">
							<div class="btn-toolbar row-action">
									...
									<button class="btn btn-info" title="Edit" onclick=job_position_update("<?php echo $keys['project_ID'];?>")><i class="icon-edit"></i></button>
									<button class="delete btn btn-danger" title="Delete" onclick=delete_post("<?php echo $keys['project_ID'];?>")><i class="icon-trash "></i></button>
